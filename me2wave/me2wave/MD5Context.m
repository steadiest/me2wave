...
- (NSString *) hmacAsStringUsingPassword: (NSString *) thePassword
{
	...
	else
    {
		...
		md5_hmac(result, [string cStringUsingEncoding:[NSString defaultCStringEncoding]], [string length], [thePassword cStringUsingEncoding:[NSString defaultCStringEncoding]], [thePassword length]);
